...
const createStandaloneVariants = () =>
  createRequestBuilder({
    projectKey: config.projectKey,
    customServices: {
      'standalone-variant': {
        type: 'standalone-variant',
        endpoint: '/standalone-variants',
        features: [features.query, features.queryOne]
      }
    }
  })['standalone-variant']
const createProductSelectionService = () =>
  createRequestBuilder({
    projectKey: config.projectKey,
    customServices: {
      'product-selection': {
        type: 'product-selection',
        endpoint: '/product-selections',
        features: [features.query, features.queryOne]
      }
    }
  })['product-selection']
...
export const standalonePriceService = createStandalonePrice()
export const standaloneVariantsService = createStandaloneVariants()
export const productSelectionService = createProductSelectionService()
